...
/** @type {string} */
const CACHE_VERSION = '1763515525|17130057151';
/** @type {string} */
const CACHE_PREFIX = 'Trivia Game Try-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Trivia Game Try.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Trivia Game Try.html","Trivia Game Try.js","Trivia Game Try.offline.html","Trivia Game Try.icon.png","Trivia Game Try.apple-touch-icon.png","Trivia Game Try.audio.worklet.js","Trivia Game Try.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Trivia Game Try.wasm","Trivia Game Try.pck","Trivia Game Try.side.wasm"];
